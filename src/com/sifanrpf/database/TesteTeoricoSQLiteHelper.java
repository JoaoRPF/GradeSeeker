...
public class TesteTeoricoSQLiteHelper extends SQLiteOpenHelper{

	public static final String TABLE_TESTE_TEORICO = "Testes_Teoricos";
	...
	private static final String DATABASE_NAME = "testeTeorico.db";
	...
	public TesteTeoricoSQLiteHelper(Context context){
	...
	public void onUpgrade(SQLiteDatabase bd, int oldVersion, int newVersion){
		...
		bd.execSQL("DROP TABLE IF EXISTS " + TABLE_TESTE_TEORICO);
		onCreate(bd);
	}
}
