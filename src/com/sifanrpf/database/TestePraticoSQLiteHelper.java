...
public class TestePraticoSQLiteHelper extends SQLiteOpenHelper{

	public static final String TABLE_TESTE_PRATICO = "Testes_Praticos";
	...
	private static final String DATABASE_NAME = "testePratico.db";
	...
	public TestePraticoSQLiteHelper(Context context){
	...
	public void onUpgrade(SQLiteDatabase bd, int oldVersion, int newVersion){
		...
		bd.execSQL("DROP TABLE IF EXISTS " + TABLE_TESTE_PRATICO);
		onCreate(bd);
	}
}
