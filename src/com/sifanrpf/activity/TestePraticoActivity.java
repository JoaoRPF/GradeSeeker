...
public class TestePraticoActivity extends ActionBarActivity implements OnItemSelectedListener{
	//private DisciplinaDataSource disciplinaDataSource;
		...
		protected void onCreate(Bundle savedInstanceState){
			...
			setContentView(R.layout.teste_pratico);
			...
			spNumeroTestes = (Spinner) findViewById(R.id.spinnerNumeroTestesPraticos);
			...
			final EditText percentagemTestePratico = (EditText) findViewById(R.id.percentagemTestePratico);
			percentagemTestePratico.setFilters(new InputFilter[]{ new InputFilterMaxMin("1", "100")});
			
			percentagemTestePratico.setOnFocusChangeListener(new View.OnFocusChangeListener() {
		        @Override
			...
			listViewPercs.setOnItemClickListener(new OnItemClickListener() {
				public void onItemClick(AdapterView<?> parent, View view, final int position, long id){
					AlertDialog.Builder requestPercentagem = new AlertDialog.Builder(TestePraticoActivity.this);
			...
			final Button button = (Button) findViewById(R.id.gravarTestePratico);
			button.setOnClickListener(new View.OnClickListener() {
				public void onClick(View v) {
					String percentagemTesteStr = percentagemTestePratico.getText().toString();
		...
		public void criaTestePratico(){
			TestePratico teste = testePraticoDataSource.createTestePratico(nomeDisciplina, numeroTestes, percentagemTotal);
		}
		...
		public void gravaCotacaoTestes(){
			if(flagCotacoes==0){
				...
				testePraticoDataSource.gravaCotacaoTestes(nomeDisciplina, numeroTestes, cotacoes);
			}
		}
		...
		public void gravaNovaPercentagem(){
			testePraticoDataSource.alteraCotacaoTeste(nomeDisciplina, numeroTestes, percsTemporarias);
		}
